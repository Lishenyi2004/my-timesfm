...
EVAL_CHECKPOINT_PATH="/mnt/shared-storage-gpfs2/speechllm-share/lishenyi/Time-MoE/logs_2/time300b_m_gt_spread/best_model"           # 例: "${REPO_ROOT}/logs/time_moe3"
EVAL_OUTPUT_DIR="results_test/timesfm_all_gt_pread_m"                # 例: "results/timesfm_change"
